...
//                    {
//                        Console.Error.WriteLine("Is in Area " + a.Row + " " + a.Column + " : " + a.Score + " ( Visited : " + a.VisitedTimes + " times )");
//                        a.VisitedTimes++;
//                    }
//                }
//                );
...
//    public class Area
//    {
//        public const int L = 1600;
//        public const int l = 900;
...
//                    }
//                }
//                int unvisitedWeight = this.VisitedTimes < 5 ? 10 : 0;
//                //return ghostsWeight + unvisitedWeight - this.VisitedTimes - this.Malus;
//                return unvisitedWeight - this.VisitedTimes - this.Malus;
//            }
//        }
...
//                    }
//                }
//                Console.Error.WriteLine("Area " + chosenArea.Row + " " + chosenArea.Column + " : " + chosenArea.Score + " ( Visited : " + chosenArea.VisitedTimes + " times )");
...
//                {
//                    Console.WriteLine(buster.PrintDecision() + " " + buster.Decision.Mission.ToString());
//                }
//            }
//        }
...
//                {
//                    // Stunned :/
//                    //nothing to do ? // warn intercepted or something ?
//                }
...
//                if(allWeakest != null && allWeakest.DistanceTo(buster) < 3*GameConstants.BusterMove)
//                {
