...
//                Ghost closest = this.FindClosestGhost();
//                if (closest == null)
//                {
...
//                else
//                {
//                    double distance = closest.Position.GetDistanceTo(this.Position);
//                    if (distance > Constants.BustMax)
//                    {
//                        //Get Closer
//                        Console.Error.WriteLine("Get closer");
//                        return "MOVE " + closest.Position.ToString();
//                    }
...
//                                            closest.Position.x + (Game.MyTeamId == 0 ? -Constants.BustMin : Constants.BustMin) / 2,
//                                            closest.Position.y + (Game.MyTeamId == 0 ? -Constants.BustMin : Constants.BustMin) / 2
//                                                        ).ToString();
//                    }
//                    // Else we can Bust
//                    Console.Error.WriteLine("We can Bust");
//                    return "BUST " + closest.Id;
//                }
//            }
//        }
